...
class EconomyActivity : AppCompatActivity() {
    ...
    private fun layDuLieuMauHocKy1_22_23() = listOf(
        ...
        MonHoc("111113", "Nhập môn Lập trình Lý Thuyết", 2400000, 1200000, "02/08/2022", 2),
        MonHoc("111113", "Nhập môn Lập trình Thực Hành", 1200000, 1200000, "02/08/2022", 2)
    )

    private fun layDuLieuMauHocKy2_22_23() = listOf(
        MonHoc("111114", "Cơ sở dữ liệu", 3600000, 3600000, "20/11/2022", 3),
        MonHoc("111115", "Tiếng Anh 1", 2400000, 1200000, "20/11/2022", 2),
        MonHoc("111116", "Kỹ Thuật lập Trình Lý Thuyết", 2400000, 1800000, "20/11/2022", 2),
        MonHoc("111116", "Kỹ Thuật lập Trình Thực Hành", 1200000, 0, "20/11/2022", 2)
    )
